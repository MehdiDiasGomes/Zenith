      ...
      >
        ...
        >
          ...
          <div class="flex flex-col justify-center p-8 lg:p-10">
            ...
            <span class="mb-3 inline-flex self-start rounded-full bg-zenith-gold-vivid/8 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-zenith-gold-vivid/70 dark:bg-zenith-gold-vivid/10 dark:text-zenith-gold-vivid/60">

...
La boutique en ligne, c'est un autre niveau de complexité. Catalogue produits, panier, paiement sécurisé, gestion des stocks... **comptez à partir de 1 500 € pour une boutique de 20 produits**.

## Ce qui fait vraiment varier le prix

### 1. La complexité fonctionnelle

Un site avec réservation en ligne, espace client ou connexion à un ERP coûte plus cher qu'un site vitrine statique. Chaque fonctionnalité sur mesure représente des heures de développement.

### 2. Le contenu

Si vous fournissez tous vos textes et photos, le coût baisse. Si le développeur doit tout produire (rédaction SEO, photographie, illustrations), le prix monte.

### 3. Le design

Un design sur mesure, créé de zéro pour votre marque, coûte plus cher qu'un template adapté. Mais il vous garantit une identité visuelle unique et professionnelle.

### 4. La maintenance

Un site, ça s'entretient. Hébergement, mises à jour de sécurité, sauvegardes, petites modifications... Prévoyez **un forfait mensuel de 30 à 80 €** selon la complexité.
...
Chez Zenith, je propose des tarifs fixes et détaillés avant tout engagement :

- **Site vitrine** : à partir de 800 € (paiement en 3 fois sans frais)
- **Site vitrine avancé** : à partir de 1 200 €
- **E-shop** : à partir de 1 500 €

Et le premier échange est gratuit. On parle de votre projet, j'analyse vos besoins, et vous repartez avec une proposition claire et chiffrée — sans engagement de votre côté.
